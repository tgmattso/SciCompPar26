...
**
**           Simplified the code.  It doesn't use structures for the complex type.
**           I removed the ambiguity in the original code with a file scope 
**           variable for the complex point to be tested (October 2023)
*/
